...
export const Route = createFileRoute("/brand-guidelines/ai-for-techies")({
  head: () => ({ meta: [{ title: "AI for Techies — Brand & Style" }] }),
  component: () => (
    <div>
      <PageHeader eyebrow="Brand · AI for Techies" title="AI for Techies — Brand & Style" intro="Python using AI — brand direction." />
      ...
      <div className="mt-6">
        ...
        <a
          href="https://www.youtube.com/@AIForTechies"
          target="_blank"
          rel="noreferrer"
        ...
        >
          ...
          <span>
            <span className="block font-medium text-foreground">AI for Techies</span>
