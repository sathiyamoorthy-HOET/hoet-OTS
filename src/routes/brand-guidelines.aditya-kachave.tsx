...
export const Route = createFileRoute("/brand-guidelines/aditya-kachave")({
  head: () => ({ meta: [{ title: "Aditya Kachave — Organic Channel" }] }),
  component: () => (
    <div>
      <PageHeader eyebrow="Brand · Organic · Founder" title="Aditya Kachave" intro="Founder channel — reference for organic tone, pacing and on-screen style." />
      ...
      <div className="mt-6">
        ...
        <a
          href="https://www.youtube.com/channel/UCkZyATqruBa-0XFO3tksGgw"
          target="_blank"
          rel="noreferrer"
        ...
        >
          <img src={adityaKachave} alt="Aditya Kachave" loading="lazy" className="h-10 w-10 shrink-0 rounded-md object-cover" />
          <span>
            <span className="block font-medium text-foreground">Aditya Kachave</span>
