    ...
    <div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {BRANDS.map((b) => {
          ...
          return b.to ? (
            <Link key={b.name} to={b.to} className="group rounded-lg border border-white/10 bg-card p-5 hover:border-white/30">
              {body}
            ...
            <div key={b.name} className="rounded-lg border border-white/10 bg-card p-5 opacity-80">
              {body}
