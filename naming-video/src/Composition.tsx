...
const SEGMENTS: Seg[] = [
  { value: "AI", field: "Product", meaning: "The product or brand.", color: "#38bdf8" },
  { value: "AK", field: "Copywriter", meaning: "Copywriter's initials — AK = Aditya Kachave.", color: "#fbbf24" },
  { value: "VS101", field: "Asset Type + Number", meaning: "Asset code + sequence — VS = Video Script.", color: "#34d399" },
  { value: "9016", field: "Ratio", meaning: "Aspect ratio — 9016 = 9×16, 0101 = 1×1, 1609 = 16×9.", color: "#a78bfa" },
  { value: "KV", field: "POC", meaning: "Point of contact — KV = Kushagra Varma.", color: "#f472b6" },
  { value: "SM", field: "Creator", meaning: "Editor's initials — SM = Sathiya Moorthy.", color: "#22d3ee" },
];

const INTRO_END = 84;
const BUILD_START = 96;
const SEG_FRAMES = 56;
const BUILD_END = BUILD_START + SEGMENTS.length * SEG_FRAMES; // 432
...
const Eyebrow: React.FC<{ opacity: number }> = ({ opacity }) => (
  <div style={{ display: "flex", alignItems: "center", gap: 14, opacity }}>
    ...
    >
      File Naming Convention · Ads Only
    </span>
  </div>
);

export const FileNamingVideo: React.FC = () => {
      ...
      {inIntro && (
        ...
        >
          ...
          >
            ...
            >
              Product_Copywriter_AssetType+Number_Ratio_POC_Creator
            </div>
          </div>
        </AbsoluteFill>
      )}
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ marginTop: 34, fontSize: 40, fontWeight: 700 }}>
              Traceable from brief to delivery.
            </div>
            <div
              style={{
                marginTop: 16,
